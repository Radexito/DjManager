...
const SECTIONS = [
  ...
  {
    title: 'Player',
    keywords: 'play pause next previous volume mute shuffle repeat queue history seek trim',
    items: [
      ...
      'A trimmed track plays only its usable range: playback starts at the trim start and ends (and advances) at the trim end. Seeking outside the range still works while preparing a track.',
  ...
  },
  {
    ...
    items: [
      ...
      'The TIDAL view also lists your own account collections in the "My collections" panel: Playlists, Mixes & Radio (including My Daily Discovery and the video mixes) and Favorites (tracks, albums, artists, videos). The name and the ↓ button both open a collection so you can pick the tracks before anything downloads; everything downloadable is ticked up front.',
