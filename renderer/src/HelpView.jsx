...
const SECTIONS = [
  ...
  },
  {
    ...
    items: [
      ...
      'A trimmed track plays only its usable range: playback starts at the trim start and ends at the trim end. Seeking outside the range still works while preparing a track.',
      'While Prepare Track is open, reaching the trim end pauses playback there instead of advancing. With the editor closed the trim end acts like the end of the track, so the next track starts as usual.',
