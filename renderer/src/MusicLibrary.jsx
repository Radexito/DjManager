...
function MusicLibrary({ selectedPlaylist }) {
  ...
  // Minimum total pixel width so header and rows always stay in sync on narrow windows.
  ...
  return (
    <div className={`music-library${detailsTrack ? ' music-library--with-panel' : ''}`}>
      <div className="music-library__main">
        ...
        <div className="library-hscroll">
          <div className="library-hscroll-inner" style={{ minWidth: minScrollWidth }}>
            <div
              className="header"
